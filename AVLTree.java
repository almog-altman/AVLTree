...
public class AVLTree {
    ...
    public int delete(int k) {
        ...
        //delete the node and find from which node to start the re-balance
     ...
     * Returns an array [t1, t2] with two AVL trees, such that keys(t1) < x < keys(t2).
     * <p>
    ...
    public int join(IAVLNode x, AVLTree t) {
        ...
        if (this.empty() || t.empty()){
            ...
            if (this.empty())
            {
                if (!t.empty()){ //this is empty and t is not
            ...
            else if (t.empty()){ //t is rempty and this is not
     ...
     * postcondition: null iff x.getKey() is min value of the tree
     * time complexity - O(logn)
     */
    private IAVLNode predecessor(IAVLNode x) {
     ...
     * precondition: x in tree
     * precondition: tree is not empty
     * postcondition: null iff x.getKey() is max value of the tree
     * time complexity - O(logn)
     */
    private IAVLNode successor(IAVLNode x) {
     ...
     * Returns the number of operations that were made.
     * time complexity - O(logn)
     */
